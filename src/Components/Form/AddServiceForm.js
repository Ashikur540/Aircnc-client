...
const AddServiceForm = ({ handleAddHome, arrivalDate,
  setArrivalDate,
  departureDate,
  setDepartureDate,
  loading,
    ...
    <>
      <div className='flex justify-center mt-6'>
        <div className='w-full max-w-md p-8 space-y-3 text-gray-800 rounded-xl bg-gray-50'>
          <form className='space-y-6 ng-untouched ng-pristine ng-valid' onSubmit={handleAddHome}>
            ...
            <div className='flex justify-between '>
              <div className='shadow-md rounded-md my-2 p-3 flex justify-between items-center'>
                <div>
                  ...
                  <DatePicker selected={arrivalDate} onChange={e => setArrivalDate(e)} className='w-2/3' />
                </div>
              ...
              <div className='shadow-md rounded-md my-2 p-3 flex justify-between items-center'>
                <div>
                  ...
                  <DatePicker selected={departureDate} onChange={e => setDepartureDate(e)} className='w-2/3' />
                </div>
            ...
            <div className='flex space-x-4 items-center'>
              <label
                htmlFor='image'
                className='p-3 w-full text-center rounded-md cursor-pointer text-gray-500 font-bold border  border-green-600 hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 hover:border-white hover:text-white'
              >
                {uploadText}
                <input
                  onChange={e => handleImageChang(e.target.files[0])}
                  type='file'
                  name='image'
                  id='image'
                  accept='image/*'
            ...
            {/* ppreview */}
            {preview && <img src={preview} alt="imnage preview" />}
