                ...
                <div className='w-full max-w-md p-8 space-y-3 text-gray-800 rounded-xl bg-gray-50'>
                    ...
                    >
                        ...
                        <div className='flex space-x-4 items-center'>
                            <label
                                htmlFor='image'
                                className='p-3 text-center rounded-md w-full cursor-pointer text-gray-500 font-bold border  border-green-600 hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 hover:border-white hover:text-white'
                            >
                                <input
                                    type='file'
                                    name='image'
